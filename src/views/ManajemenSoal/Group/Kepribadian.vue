<template>
  <div class="d-flex flex-column">
    ...
    <ContentNotFound
      message="Kepribadian Group Not Found"
      :loading="loading"
      v-if="!isAvailable"
    >
...
export default {
  ...
  methods: {
    ...
    requestEdit(index) {
      ...
      GroupService.insertDataKepribadian({
        ...
        .then(({ data: { result, message } }) => {
          if (message == "OK") {
            ...
            this.$store.commit("snackbar/setSnack", {
              show: true,
              message: "Berhasil menyimpan data Kepribadian",
              color: "success",
            });
            this.getList();
          } else {
            ...
            this.$store.commit("snackbar/setSnack", {
              show: true,
              message: result || "Gagal menyimpan data Kepribadian",
              color: "error",
            });
          }
        })
        .catch((err) => {
          ...
          this.$store.commit("snackbar/setSnack", {
            show: true,
            message: "Gagal menyimpan data Kepribadian",
            color: "error",
          });
        });
    },
      ...
      GroupService.insertDataKepribadian({
        ...
        .then(({ data: { result, message } }) => {
          if (message == "OK") {
            ...
            this.$store.commit("snackbar/setSnack", {
              show: true,
              message: "Berhasil membuat data Kepribadian",
              color: "success",
            });
            this.getList();
          } else {
            this.$store.commit("snackbar/setSnack", {
              show: true,
              message: result || "Gagal membuat data Kepribadian",
              color: "error",
            });
          }
        })
        .catch((err) => {
          ...
          this.$store.commit("snackbar/setSnack", {
            show: true,
            message: "Gagal membuat data Kepribadian",
            color: "error",
          });
        })
        .finally(() => {
    ...
    deleteData(item, index) {
      ...
      GroupService.deleteKepribadian(item.secureId)
        .then(({ data: { result, message } }) => {
          if (message == "OK") {
            this.$store.commit("snackbar/setSnack", {
              show: true,
