  ...
  <div class="d-flex flex-column">
    <div class="d-flex flex-row justify-space-between align-center">
      <div class="d-flex flex-column" style="width: 25%">
        <p class="header-3 mb-5">Kecerdasan</p>
        <v-text-field
          v-model="search"
...
export default {
  ...
  methods: {
    ...
    requestEdit(index) {
      ...
      GroupService.insertDataKecerdasan({
        ...
        .then(({ data: { result, message } }) => {
          if (message == "OK") {
            ...
            this.$store.commit("snackbar/setSnack", {
              show: true,
              message: "Berhasil menyimpan data Kecerdasan",
              color: "success",
            });
            this.getList();
          } else {
      ...
      GroupService.insertDataKecerdasan({
        ...
        .then(({ data: { result, message } }) => {
          if (message == "OK") {
            ...
            this.$store.commit("snackbar/setSnack", {
              show: true,
              message: "Berhasil membuat data Kecerdasan",
              color: "success",
            });
            this.getList();
          } else {
            this.$store.commit("snackbar/setSnack", {
              show: true,
              message: result || "Gagal membuat data Kecerdasan",
              color: "error",
            });
          }
        })
        .catch((err) => {
          ...
          this.$store.commit("snackbar/setSnack", {
            show: true,
            message: "Gagal membuat data Kecerdasan",
            color: "error",
          });
        })
        .finally(() => {
