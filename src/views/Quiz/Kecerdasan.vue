...
export default {
  ...
  computed: {
    ...mapKecerdasanField({
      ...
      timer: "kecerdasan.timer",
      minutes: "kecerdasan.minutes",
      seconds: "kecerdasan.seconds",
      nowDate: "kecerdasan.nowDate",
      nowHour: "kecerdasan.nowHour",
      totalAnswer: "kecerdasan.totalAnswer",
      questions: "kecerdasan.questions",
      questionIndex: "kecerdasan.questionIndex",
    }),
        ...
        .then(({ data: { result, message } }) => {
          if (message == "OK") {
            ...
            this.$store.commit("snackbar/setSnack", {
              show: true,
              message: "Berhasil input nilai Kecerdasan",
              color: "success",
            });
          } else {
            this.$store.commit("snackbar/setSnack", {
              show: true,
              message: result || "Gagal input nilai Kecerdasan",
              color: "error",
            });
          }
        })
