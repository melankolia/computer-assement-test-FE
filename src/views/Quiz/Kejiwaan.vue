...
export default {
  ...
  computed: {
    ...mapKejiwaanField({
      kejiwaan: "kejiwaan",
      title: "kejiwaan.title",
      duration: "kejiwaan.duration",
      timer: "kejiwaan.timer",
      minutes: "kejiwaan.minutes",
      seconds: "kejiwaan.seconds",
      nowDate: "kejiwaan.nowDate",
      nowHour: "kejiwaan.nowHour",
      totalAnswer: "kejiwaan.totalAnswer",
      questions: "kejiwaan.questions",
      questionIndex: "kejiwaan.questionIndex",
    }),
        ...
        .then(({ data: { result, message } }) => {
          if (message == "OK") {
            ...
            this.$store.commit("snackbar/setSnack", {
              show: true,
              message: "Berhasil input nilai Kejiwaan",
              color: "success",
            });
          } else {
            this.$store.commit("snackbar/setSnack", {
              show: true,
              message: result || "Gagal input nilai Kejiwaan",
              color: "error",
            });
          }
        })
